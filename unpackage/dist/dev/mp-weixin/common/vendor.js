...
const subPackages = [
  {
    ...
    pages: [
      {
        path: "comment_page/comment_page",
        style: {
          navigationBarTitleText: ""
        }
      }
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      text: "购物车",
      iconPath: "static/tab_icons/post.png",
      selectedIconPath: "static/tab_icons/post-active.png"
    },
    {
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.0.103"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/uni/HBuilderX.4.23.2024070804/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"efgcloud","spaceId":"mp-8ceddf2a-d6f2-42b9-be7d-a6fbc44ed077","clientSecret":"3mpceOnAYXf6Dlzpk1bcyg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__200D245";
} catch (e2) {
